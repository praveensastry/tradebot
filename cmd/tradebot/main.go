...
import (
	...
	"github.com/praveensastry/tradebot/pkg/api"
	"github.com/praveensastry/tradebot/pkg/grpc"
	"github.com/praveensastry/tradebot/pkg/signals"
...
func main() {
	...
	fs.String("grpc-service-name", "tradebot", "gPRC service name")
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/praveensastry/tradebot/gh-pages/cuddle_clap.gif")
	viper.Set("hostname", hostname)
	viper.Set("version", version.VERSION)
	viper.Set("revision", version.REVISION)
	viper.SetEnvPrefix("tradebot")
